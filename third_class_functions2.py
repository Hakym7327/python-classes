...
class Smartphone(Device):
    ...
    def browse_the_net(self):
        print('Device is browsing now')
    

# Polymorphism

# Inheritance, Polymorphsm, Encapsulation, Abstraction

class Tablet(Device):
    def split_screen(self):
        print('Okay... Spliting screen')
        

class SuperPhone(Smartphone, Tablet):
    pass
